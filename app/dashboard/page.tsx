      ...
      <div className="container mx-auto py-12">
        ...
        <div className="bg-white p-6">
          ...
          <p className="text-gray-700 mb-4">
            ...
            experience. Whether you are a beginner or experienced with data,
            Walacor offers the tools you need to create, manage, and grow your
            data. We demonstrate this with this blogging application.
          </p>
          ...
          <ul className="list-disc list-inside text-gray-700 mb-4">
            ...
            <li>
              Analyze your data with detailed granularities and audit histories
            </li>
